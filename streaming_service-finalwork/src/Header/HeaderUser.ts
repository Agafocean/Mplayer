...
export class HeaderUser extends HandleElement {
  getTemplate() {
    return ` <button class="header__user"><img class="header__user__img" src=${userJpg} alt="user picture"><span class="header__user__text">Evgeny Agafonov</span><svg class="header__user__svg" width="6" height="11" viewBox="0 0 6 11" fill="none" xmlns="http://www.w3.org/2000/svg">
