...
export class AsidePlaylists extends HandleElement {
  getTemplate() {
    return ` <li class="aside__item">
              <button class="aside__btn aside__tabs-btn" id="-1" data-path="playlists"><svg width="22" height="26" viewBox="0 0 22 26" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               </svg><span class="aside__btn__text">Playlists</span>
              </button>
             </li>`
  }
}
